...
<head>
    ...
    <style>
        ...
        .container {
            ...
            margin: 0 auto;
            padding: 20px;
            background-color: rgba(120,120,120); /*mudei fundo para diferenciar do outro arquivo*/
            border-radius: 8px;
        ...
        .profissional {
            ...
            -webkit-text-stroke-color: rgb(139,0,0); /* cor da borda */
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        switch ($nivel_habilidade) {
            ...
            case 'avancado':
                ...
                break;
            case 'profissional' :
                $mensagem = "Você é excepcional! Parabéns!";
                $classe = "profissional";
                break;
            default:
